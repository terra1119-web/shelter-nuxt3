<template>
	...
	>
		<figure class="md:order-2">
			<NuxtLink
				to="https://goo.gl/maps/7LnBL2g488abwDHMA"
				target="_blank"
			>
				<img src="/images/map.svg" alt="MAP" class="w-full" />
			</NuxtLink>
		</figure>
		<div class="mt-6 md:mt-0 md:order-1 md:flex-grow">
			<figure>
				<NuxtLink
					:to="`/`"
		...
		<p class="text-center mt-6 w-full md:order-3">
			&copy;
			{{
				useDateString({
